...
const SearchBar = () => {
  ...
  const searchHandler = async () => {
    ...
    const res = await fetch(
      `${BASE_URL}/bus/search/getBusBySearch?city=${location}&distance=${distance}&maxGroupSize=${maxGroupSize}`
    );
    ...
    navigate(
      `/bus/search?city=${location}&distance=${distance}&maxGroupSize=${maxGroupSize}`,
      { state: result.data }
    );
  };
