            ...
            <Container>
                <Row>
                    ...
                    <Col lg='3'>
                        <div className='logo'>
                            <img src={logo} alt='' />
                            <p>wertyuiopasdfghjkl;zxcvbnm,liuyd<br />fcghbjntcrxvgbhjtrcvbhjntrdcvbnmkkjgf</p>
                    ...
                    <Col lg='3'>
                        ...
                        <ListGroup className='footer__quick-link'>
                            ...
                            <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
                                ...
                                <p className='mb-0'>Rajkot, India</p>
                            </ListGroupItem>
                    ...
                    <Col lg='12' className='text-center pt-5'>
                        <p className='copyright'>Copyright{year}, design & develop by CityBUS & Team. All rights reserved.</p>
                    </Col>
                </Row>
            </Container>
        </footer>
