          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <h1>
                  Welcome To Your <span className="highlight">CityBus</span>
                </h1>
                <p>
                  City bus system is web-based application. City Bus System
                  provides bus transportation system, a facility to reservation
                  se, cancellation seats and different types of enquiries which
                  need an instant and quick reservation. • CityBus is built for
                  manage and computerize the traditional database, ticket
                  booking and tracking bus and travel made easy. It maintains
                  all data of users, bus details, reservation details, booking
          ...
          <Row>
            <Col lg="6">
              <div className="experience__content">
                ...
                <p>
                  we provide best service to are passenger
                  <br />
                  We have most HAAPY PASSENGER!!
                </p>
              </div>
        ...
        <Container>
          <Row>
            <Col>
              ...
              <h2 className="team__title">About Teams</h2>
            </Col>
            <Col lg="12">
              <Teams />
            </Col>
